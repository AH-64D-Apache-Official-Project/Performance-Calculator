...
export const maxTqDE = new InterpTable2D(
  ...
  [
    [ 1.29, 1.34, 1.35, 1.27, 1.15 ],
    [ 1.28, 1.33, 1.31, 1.2, 1.05 ],
    [ 1.19, 1.23, 1.21, 1.11, 0.96 ],
    [ 1.11, 1.15, 1.12, 1.02, 0.88 ],
    [ 1.03, 1.07, 1.03, 0.94, 0.79 ]
  ]
)
...
export const maxTqSE = new InterpTable2D(
  ...
  [ 0, 2000, 4000, 6000, 8000 ],
  [
    [ 1.3, 1.34, 1.36, 1.31, 1.23 ],
    [ 1.26, 1.31, 1.34, 1.25, 1.12 ],
    [ 1.17, 1.22, 1.24, 1.15, 1.02 ],
    [ 1.09, 1.13, 1.14, 1.06, 0.93 ],
    [ 1.01, 1.05, 1.05, 0.97, 0.85 ]
  ]
)
...
export const maxGwtIGE = new InterpTable2D(
  ...
  [ 0, 2000, 4000, 6000, 8000 ],
  [
    [ 20260, 20260, 20260, 20260, 20260 ],
    [ 20260, 20260, 20260, 20260, 20260 ],
    [ 20260, 20260, 20260, 20260, 19644 ],
    [ 20260, 20260, 20260, 20088, 18006 ],
    [ 20260, 20260, 20260, 20260, 20260 ]//These values are wrong, fix them...jackass
  ]
)
...
export const maxGwtOGE = new InterpTable2D(
  ...
  [ 0, 2000, 4000, 6000, 8000 ],
  [
    [ 19442, 19122, 18973, 18781, 18458 ],
    [ 18953, 18691, 18571, 18378, 18045 ],
    [ 18449, 18252, 18153, 17959, 17157 ],
    [ 17949, 17805, 17722, 17526, 15722 ],
    [ 17453, 17352, 17273, 16359, 14349 ]
  ]
)
...
export const goNoGoTqIGE = new InterpTable2D(
    ...
    [
      ...
      [ 0.91, 0.93, 0.95, 0.98, 0.96 ],
      [ 0.94, 0.96, 0.98, 1.00, 0.88 ],
      [ 0.97, 1.00, 1.00, 0.94, 0.79 ]
    ]
)
...
export const goNoGoTqOGE = new InterpTable2D(
    ...
    [ 0, 2000, 4000, 6000, 8000 ],
    [
      [ 0.82, 0.82, 0.82, 0.92, 0.82 ],
      [ 0.81, 0.81, 0.82, 0.94, 0.82 ],
      [ 0.81, 0.81, 0.82, 0.98, 0.79 ],
      [ 0.80, 0.81, 0.81, 1.00, 0.72 ],
      [ 0.80, 0.80, 0.81, 0.94, 0.65 ]
    ]
)
